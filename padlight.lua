...
SNES = {
  ...
  B_RELEASED = gfx.RGBA(0xF0, 0xBA, 0x24, 0xFF),
...
SNES.SELECT_PRESSED = SNES.COLOR_B_PRESSED
SNES.SELECT_RELEASED = SNES.DPAD_RELEASED
SNES.START_BORDER = SNES.BORDER
SNES.START_PRESSED = SNES.COLOR_B_PRESSED
...
function draw_select_and_start(drawer, x, y, pressed, theme)
  ...
  drawer:draw_slanted_button(5+x, y, theme.START_BORDER,
      pressed['SELECT'] and theme.START_PRESSED or theme.START_RELEASED)
end
